...
#   filename:  mzTab_m_openapi.yml
#   timestamp: 2025-07-30T11:36:07+00:00
...
class PublicationItem(BaseModel):
    type: Type = Field(..., description='The type qualifier of this publication item.')
    accession: str = Field(
...
class Contact(BaseModel):
    id: Optional[conint(ge=1)] = None
    name: Optional[str] = Field(None, description="The contact's name.")
    affiliation: Optional[str] = Field(None, description="The contact's affiliation.")
    email: Optional[constr(regex=r'^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$')] = (
        Field(None, description="The contact's e-mail address.")
    )
    orcid: Optional[constr(regex=r'^[0-9]{4}-[0-9]{4}-[0-9]{4}-[0-9]{3}[0-9X]{1}$')] = (
        Field(None, description="The contact's orcid id, without https prefix.")
    )
...
class SmallMoleculeFeature(BaseModel):
    ...
    adduct_ion: Optional[constr(regex=r'^\[\d*M([+-][\w\d]+)*\]\d*[+-]$')] = Field(
        None,
...
class MzTab(BaseModel):
    ...
    smallMoleculeFeature: List[SmallMoleculeFeature] = Field(
        ...,
    ...
    smallMoleculeEvidence: List[SmallMoleculeEvidence] = Field(
        ...,
